...
class BayWatcher(object):
    ...
    def init_plot(self):
        ...
        self.axes = [ax1, ax3, ax4, ax5, ax2, ax6, inax]
        # -----------------------------------
        ...
        self.axes[0].set_xlabel('Vs (km/s)')
        self.axes[0].set_ylabel('Depth (km)')
        ...
        self.axes[1].set_ylabel('Vs (km/s)')
        self.axes[1].set_xlabel('Period (s)')
        self.axes[2].set_ylabel('RF amplitude')
        self.axes[2].set_xlabel('Time (s)')
        self.axes[3].set_ylabel('H/V ratio')
        self.axes[3].set_xlabel('Period (s)')
        ...
        self.axes[6].axvline(vpvs, color='k', ls=':')
